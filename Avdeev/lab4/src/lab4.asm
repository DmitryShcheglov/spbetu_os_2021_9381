...
DATA SEGMENT
	NOTLOAD_MES db "interruption not loded", 13, 10, '$'
	RESTORED_MES db "interruption reloaded", 13, 10, '$'
	ALREADY_LOAD_MES db "interruption loaded", 13, 10, '$'
	LOADING_MES db "interruption already installed", 13, 10, '$'
DATA ENDS
