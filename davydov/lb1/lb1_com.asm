...
GET_PC_TYPE PROC NEAR
	...
	cmp al, 0FFh ; распознавание типа PC по специльной технической таблице
	je pc_type_1_case
	cmp al, 0FEh
	je pc_type_2_case
	cmp al, 0FBh
...
pc_type_1_case:
	mov dx, offset pc_type_1 ; загрузка в зависимости от значения al смещения нужной строки 
	jmp final_step
pc_type_2_case:
