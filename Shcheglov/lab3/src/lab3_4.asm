...
ALLOC_MEM_SUC db 'Allocating memory ended successful!', 0Dh, 0Ah, '$'
ALLOC_MEM_FAIL db 'Allocating memory ended with failure!', 0Dh, 0Ah, '$'
...
GET_MEM PROC near
    ...
    int 21h
    jc fail
    mov DX, offset ALLOC_MEM_SUC
    call OUTPUTTING_STRING_TO_CONSOLE
    ret
fail:
	mov DX, offset ALLOC_MEM_FAIL
	call OUTPUTTING_STRING_TO_CONSOLE
	ret
GET_MEM ENDP
;==============================================
